...
----
dependencies {
    compile 'com.github.vineey:rsql-querydsl-all:1.0.0'
  }
----
...
----
dependencies {
    compile 'com.github.vineey:rsql-querydsl-filter:1.0.0'
  }
----
...
----
dependencies {
    compile 'com.github.vineey:rsql-querydsl-spring:1.0.0'
  }
----
