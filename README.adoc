...
image:https://img.shields.io/maven-central/v/org.apache.maven/apache-maven.svg["Maven Central", link="http://repo1.maven.org/maven2/com/github/vineey/archelix-rsql/"]
endif::env-github[]
